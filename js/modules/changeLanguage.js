const languages = {
  "en": {
    ...
    "education-li3": "RS Schools Course «JavaScript/Front-end. Stage 1» (completed)",
    "education-li4": "English Pre Intermediate. I practice and improve my English almoust every day",
  ...
  "ru": {
    ...
    "education-li3": "Курс RS Schools «JavaScript/Front-end. Этап 1» (завершен)",
    "education-li4": "Английский A2+. Я практикуюсь и совершенствую язык почти каждый день",
